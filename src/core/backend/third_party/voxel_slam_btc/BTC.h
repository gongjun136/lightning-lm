...
typedef struct ConfigSetting {
  ...
  int proj_plane_num_ = 2;
  float proj_image_resolution_ = 0.5;
  float proj_image_high_inc_ = 0.1;
  float proj_dis_min_ = 0;
  float proj_dis_max_ = 5;
  float summary_min_thre_ = 10;
  int line_filter_enable_ = 1;
  int touch_filter_enable_ = 0;

  /* for STD */
  float descriptor_near_num_ = 15;
  float descriptor_min_len_ = 2;
  float descriptor_max_len_ = 50;
  float non_max_suppression_radius_ = 2.0;
  ...
  float normal_threshold_ = 0.2;
  float dis_threshold_ = 0.5;
